        ...
        setupReporters = function() {
            return window.onload = function() {
                ...
                if (window.jasmine) {
                    ...
                    if ("%teamcity%" == "true") jasmine.getEnv().addReporter(new jasmine.TeamcityReporter());
                    if ("%junit%" == "true") jasmine.getEnv().addReporter(new JUnitXmlReporter("%save_path%", "%consolidate%"));
